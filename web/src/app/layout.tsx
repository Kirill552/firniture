...
export const metadata: Metadata = {
  ...
  description:
    "Загрузите фото или PDF эскиза: сервис снимет размеры, соберёт спецификацию и выдаст DXF с присадкой и PDF карты раскроя. Идёт открытая бета — бесплатно.",
  openGraph: {
    type: "website",
    locale: "ru_RU",
    ...
    description:
      "Фото наброска превращается в спецификацию, DXF с точками присадки и карту раскроя. Открытая бета: выгрузка файлов без оплаты.",
    images: [
      {
        url: "/og.jpg",
        width: 1200,
  ...
  twitter: {
    ...
    title: "Эскиз клиента — в точный заказ",
    description:
      "Спецификация, DXF с присадкой и карта раскроя из фото наброска. Открытая бета — бесплатно.",
    images: ["/og.jpg"],
  },
