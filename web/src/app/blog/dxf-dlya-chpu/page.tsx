      ...
      <div className="mx-auto max-w-[760px] px-6 py-16">
        ...
        <div className="mt-10 space-y-8 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <p>
              Этот шаг остаётся на стороне цеха: оператор открывает наш DXF
              в своей CAM, назначает инструмент и стратегию под конкретный
              станок и только потом выпускает программу. Мы сознательно не
              генерируем G-code в облаке: неверифицированная на станке
              программа стоит сломанной фрезы или шпинделя, а такую
              ответственность нельзя брать вслепую, не видя станка.
            </p>
          </section>
