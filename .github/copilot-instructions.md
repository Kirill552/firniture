...
Вносить минимально-инвазивные изменения. Возвращать только diff/hunks.
Не удалять несвязанный код/стили, сохранять импорт-цепочки, тест-идентификаторы, фиче-флаги и ARIA.
При сомнениях — задай уточняющий вопрос, не переписывай файл целиком.
Соблюдать существующий стиль/линтер и архитектурные договорённости репозитория.
